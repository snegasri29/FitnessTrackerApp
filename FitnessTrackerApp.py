...
def user_authentication():
     # Add image and title
    st.image("Fitness.png", width=200)
...
# Sidebar
    ...
    st.sidebar.image("Fitness.png", use_column_width=True)

    st.sidebar.header("About")
    st.sidebar.write("Welcome to Fitness Tracker, your personal assistant assistant!")
